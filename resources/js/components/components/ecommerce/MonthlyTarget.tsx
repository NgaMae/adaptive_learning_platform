    ...
    return (
        <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
                <div>
                    <p className="mb-1 text-center text-theme-xs text-gray-500 sm:text-sm dark:text-gray-400">Target</p>
                ...
                <div>
                    <p className="mb-1 text-center text-theme-xs text-gray-500 sm:text-sm dark:text-gray-400">Revenue</p>
                    <p className="flex items-center justify-center gap-1 text-base font-semibold text-gray-800 sm:text-lg dark:text-white/90">
                        $20K
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div>
                    <p className="mb-1 text-center text-theme-xs text-gray-500 sm:text-sm dark:text-gray-400">Today</p>
                    <p className="flex items-center justify-center gap-1 text-base font-semibold text-gray-800 sm:text-lg dark:text-white/90">
                        $20K
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
